...
public class MusicController extends BaseController {
    ...
    public @ResponseBody ModelMap Musics_of_Singer(
      @RequestParam("singer_id") Integer id,
    ...
    public @ResponseBody ModelMap Music_of_MusicId(
      @RequestParam("music_id") Integer id,
      @RequestParam(required = true, defaultValue = "1", name = "pageNum") Integer pageNum,
      @RequestParam(required = false, defaultValue = "10", name = "pageSize") Integer pageSize
    ) {
        ModelMap model = new ModelMap();
    ...
    public @ResponseBody ModelMap All_Musics(
      @RequestParam(required = true, defaultValue = "1", name = "pageNum") Integer pageNum,
      @RequestParam(required = false, defaultValue = "10", name = "pageSize") Integer pageSize
    ) {
        ModelMap model = new ModelMap();
    ...
    public @ResponseBody ModelMap All_Singers(
      @RequestParam(required = true, defaultValue = "1", name = "pageNum") Integer pageNum,
      @RequestParam(required = false, defaultValue = "10", name = "pageSize") Integer pageSize
    ) {
        ModelMap model = new ModelMap();
    ...
    public @ResponseBody ModelMap Musics_of_Mname(
      @RequestParam("music_name") String name,
      @RequestParam(required = true, defaultValue = "1", name = "pageNum") Integer pageNum,
      @RequestParam(required = false, defaultValue = "10", name = "pageSize") Integer pageSize
    ) {
        ModelMap model = new ModelMap();
        try {
            PageHelper.startPage(pageNum, pageSize);
            List<Music> musics = musicService.getByMusicName(name, false);
    ...
    public @ResponseBody ModelMap Kinds_of_Singers(
      @RequestParam("country") String lang, @RequestParam("sex") Boolean gender,
      @RequestParam("isBand") Boolean isBand,
      @RequestParam(required = true, defaultValue = "1", name = "pageNum") Integer pageNum,
      @RequestParam(required = false, defaultValue = "10", name = "pageSize") Integer pageSize
    ) {
        ModelMap model = new ModelMap();
    ...
    public @ResponseBody ModelMap All_Labels(
      @RequestParam(required = true, defaultValue = "1", name = "pageNum") Integer pageNum,
      @RequestParam(required = false, defaultValue = "10", name = "pageSize") Integer pageSize
    ) {
        ModelMap model = new ModelMap();
